...
impl FromWorld for WorldAssets {
    fn from_world(world: &mut World) -> Self {
        ...
        let mut images: HashMap<&'static str, Handle<Image>> = HashMap::from([
            ...
            ("cross", assets.load("images/icons/cross.png")),
            ...
            ("neutral", assets.load("images/icons/neutral.png")),
            ("research", assets.load("images/icons/research.png")),
            ("tick", assets.load("images/icons/tick.png")),
            ...
            ("arctic", assets.load("images/events/arctic.png")),
            ...
            ("crypto-hub", assets.load("images/events/crypto-hub.png")),
            ("currency-reevaluation", assets.load("images/events/currency-reevaluation.png")),
            ("ddos", assets.load("images/events/ddos.png")),
            ("drought", assets.load("images/events/drought.png")),
            ("emissions", assets.load("images/events/emissions.png")),
            ...
            ("mining-nationalization", assets.load("images/events/mining-nationalization.png")),
            ...
            ("surprise", assets.load("images/events/surprise.png")),
            ("synthetic-meat", assets.load("images/events/synthetic-meat.png")),

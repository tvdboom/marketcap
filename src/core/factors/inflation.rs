...
impl Factor for Inflation {
    ...
    fn description(&self) -> String {
        ...
        In the game, there is only one (global) inflation, tied to the global economy, where \
        a thriving economy has a higher chance of seeing inflation rise. Inflation is also \
        affected by increases in money supply (taking loans) and government policies."
            .to_string()
    }

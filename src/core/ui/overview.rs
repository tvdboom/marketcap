...
use crate::core::ui::state::{ActiveModal, CommodityModal, CreditTab, OverviewTab, Tab, UiState};
                    ...
                    for owned in commodities.iter() {
                        ...
                        body.row(30., |mut row| {
                            ...
                            if row.response().clicked() {
                                ...
                                if let InstrumentKind::Commodity(name) = owned.kind {
                                    ui_state.commodity_modal = CommodityModal { name, ..default() };
                                }
                            }
                        });
                    }
